...
class mainWindow(object):
    def __init__(self,master):
        ...
        self.b.pack()
        self.b2=Button(master,text="assign values",command=lambda: sys.stdout.write(self.entryValue()+'\n'))
        self.b2.pack()
...
def get_newObj_traits():
    ...
    for i in range(myobject.NSites):
        ...
        myobject.sounds.append("sounds/" + myobject.name + str(i) + ".mp3")
    ...
    for i in range(myobject.NSites):
        ...
        mysound.export("sounds/" + myobject.name + str(i) + '.mp3', format='mp3') # Save as mp3 file
